                ...
                <Row align="middle" gutter={16} >
                    ...
                    <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                        <Form.Item
                            label="Pages"
                            name="pages"
                            rules={[{ message: 'Please select a page type' }]}
                        >
                            <Select placeholder="Select a page type" onChange={handlePageName}>
                    ...
                    {page === 'Home' || page === 'Tutoring & Classes' ? (
                        <>
                            <Col xs={24} sm={24} md={12} lg={12} xl={12}>
                                <Form.Item
                                    label="State"
                                ...
                                >
                                    <Select
                                        ...
                                        disabled={page === 'Home' || page === 'Tutoring & Classes'}
                                    >
                                        {state.map((item) => (
