...
import { Form, Input, Select, Button, Row, Col, message, Typography, Upload, Flex, Tooltip, InputNumber, Checkbox, List } from 'antd';
...
export default function Page() {
	...
	// const handleAddFeature = (values) => {
	// 	setFeatures([...features, { name: values.feature, available: values.available }]);
	// 	form.resetFields();
	// };
			...
			<div style={{ padding: '20px' }}>
				<Row gutter={[16, 16]} align="middle">
					<Col className="" xs={24} sm={24} md={12} lg={12} xxl={12} xl={12}>
						...
						<p style={{ marginLeft: '30px' }}>( {packageData ? 'Edit a Package For Each State Exam' : 'Create a Package For Each State Exam'})</p>
					</Col>
				...
				<div className='desktop-view card-dash shadow-none'>
					<Form size="large" layout="vertical" form={form} onFinish={onFinish}
						...
						<Row gutter={16}>
							...
							<Col xl={24} lg={24} md={6} sm={0}>
								<Form.Item
									name="feature"
									label="Feature Name"
									rules={[{ required: true, message: "Please enter a feature name!" }]}
								>
									<Input placeholder="Enter feature (e.g., Unlimited Access)" />
								</Form.Item>
								...
								{features.length > 0 && (
									<List
										header={<Typography.Title level={5}>Plan Features</Typography.Title>}
										bordered
										dataSource={features}
