...
import { setDrawer, setLoading, setMenuId, setReload } from '@/redux/reducers/headerMenuReducer'
...
export default function HeaderMenu({ activeKey }: Props) {
    const { menuId, drawer, loading, reload } = useAppSelector((state: RootState) => state.headerMenuReducer);
    ...
    return (
        <>
            ...
            <HeaderData activeKey={activeKey} onEdit={(data: editData) => handleEdit(data)} />
